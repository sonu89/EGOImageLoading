...
@property(nonatomic,assign) BOOL memoryCaching;
@end
...
-(void) egoImageView:(EGOImageView*) egoImgView startedDownloadingImageForURL : (NSURL*) theURL;
-(void) egoImageView:(EGOImageView*) egoImgView finishedDownloadingImageForURL : (NSURL*) theURL;
@end